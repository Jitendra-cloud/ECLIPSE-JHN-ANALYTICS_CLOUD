...
define view entity ZDT187v_JHN_Flight_Cube
  as select from /DMO/I_Flight
  association [0..1] to ZDT187v_JHN_Airline_Dim as _Airline     on  _Airline.CarrierId = $projection.AirlineID
  association [0..1] to ZDT187v_JHN_Conn_Dim    as _Connection  on  _Connection.CarrierId    = $projection.AirlineID
  ...
  association [0..1] to ZDT187v_JHN_Airport_Dim as _AirportFrom on  _AirportFrom.AirportId = $projection.airportfromid
  association [0..1] to ZDT187v_JHN_Airport_Dim as _AirportTo   on  _AirportTo.AirportId = $projection.airporttoid
{
